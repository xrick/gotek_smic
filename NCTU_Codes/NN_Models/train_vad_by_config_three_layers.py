...
CurrentDateString = "{}".format(str(date.today()).replace("-", ""))
...
def trainProcessEntry(h1_layer_num=512, h2_layer_num=32, batch_size = 40, learning_rate=0.008, \
    ...
    file_handle.write("Experiment Start Time: {}".format(datetime.datetime.now()))
    ...
    # Parameters
    learning_rate = learning_rate#current_lr#learning_rates_list[idx]  #eeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee0.01
    ...
    with tf.Session() as sess:
        ...
        spio.savemat("../weight/8+2band(25ms)/w_node_{}x{}_{}_{}.mat".format( h1_layer_num, h2_layer_num, CurrentDateString),
                     {'w1': weight1, 'w2': weight2, 'w3': weight3, 'b1': bias1, 'b2': bias2, 'b3': bias3})

        saver.save(sess, "../ExpResults/model_{}x{}_lr_{}".format(h1_layer_num, h2_layer_num, \
                                                                              current_lr_str, CurrentDateString))
...
time_log_file = "../time_log/timelog_{}.log".format(CurrentDateString)
