...
function [ceps,freqresp,fb,fbrecon,freqrecon] = ...
		mfcc(input, samplingRate, windowSize, windowStep)
...
% windowSize = 256;
% windowSize = samplingRate*0.025;		
                % Standard says 400, but 256 makes more sense  %%%%% fs=8000,window=32ms ; fs=16000,window=16ms
