...
def main(_):
    ...
    model = model_obj(optimizer=Config.optimizer, loss=Config.loss, model_settings=Config.model_settings,
                      train=True,num_hidden=Config.num_hidden,num_layers=Config.num_layers)
    estimator = Estimator(model_name=Config.model_name,
                          model=model,
                          ...
                          mode=Config.mode,
                          with_ctc=Config.with_ctc,
                          random_samples_mini_batch = Config.rnd_mini_batches,
                          silence_label = Config.silence_label,
                          unknown_label = Config.unknown_label,
                          classes = Config.classes,
                          augmentation_ops=Config.augmentation_ops,
                          augmentation_percentage=Config.augmentation_percentage,
                          ...
                          testing_list= Config.test_data_names,
                          validation_list=Config.val_data_names)
